      ...
      <svg ariaHidden="true" style={{ position: 'absolute', width: 0, height: 0, overflow: 'hidden' }} version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
        <defs>
          ...
          <symbol id="icon-flag" viewBox="0 0 32 32">
            <title>flag</title>
            <path d="M14.2 31l-14-26c-0.4-1-0.2-2.2 0.8-2.8 1-0.4 2.2-0.2 2.8 0.8l14 26c0.4 1 0.2 2.2-0.8 2.8-1 0.4-2.2 0.2-2.8-0.8z"></path>
            <path d="M32 11.4c-5.6 5-12.4-1.2-16.6 6.2l-6.4-11.4c4.2-7.4 11-1.2 16.4-6.2l6.6 11.4z"></path>
          </symbol>
          <symbol id="icon-share" viewBox="0 0 28 32">
            <title>share</title>
            <path d="M22 12c3.308 0 6-2.692 6-6s-2.692-6-6-6c-3.308 0-6 2.692-6 6 0 0.448 0.058 0.88 0.15 1.3l-6.438 4.022c-1.024-0.814-2.304-1.322-3.712-1.322-3.308 0-6 2.692-6 6s2.692 6 6 6c1.408 0 2.688-0.508 3.712-1.322l6.438 4.024c-0.092 0.418-0.15 0.85-0.15 1.298 0 3.308 2.692 6 6 6s6-2.692 6-6c0-3.308-2.692-6-6-6-1.408 0-2.686 0.508-3.712 1.322l-6.438-4.024c0.092-0.418 0.15-0.852 0.15-1.298 0-0.448-0.058-0.88-0.15-1.298l6.44-4.024c1.024 0.814 2.302 1.322 3.71 1.322zM22 4c1.102 0 2 0.896 2 2s-0.898 2-2 2c-1.102 0-2-0.896-2-2s0.898-2 2-2zM6 18c-1.102 0-2-0.896-2-2s0.898-2 2-2c1.102 0 2 0.896 2 2s-0.898 2-2 2zM22 24c1.102 0 2 0.896 2 2s-0.898 2-2 2c-1.102 0-2-0.896-2-2s0.898-2 2-2z"></path>
          </symbol>
          <symbol id="icon-play" viewBox="0 0 32 32">
            <title>play</title>
            <path d="M13.305 11.116v9.768l7.916-4.884z"></path>
            <path d="M16 32c-8.758 0-16-7.242-16-16s7.242-16 16-16 16 7.242 16 16-7.242 16-16 16zM16 3.368c-6.905 0-12.632 5.726-12.632 12.632s5.726 12.632 12.632 12.632 12.632-5.726 12.632-12.632-5.726-12.632-12.632-12.632z"></path>
          </symbol>
          ...
          <symbol id="icon-info-squared" viewBox="0 0 32 32">
            <title>info-squared</title>
            <path d="M17.778 10.844h-3.556v-3.733h3.556v3.733zM14.222 12.8h3.556v12.089h-3.556v-12.089z"></path>
          </symbol>
          ...
          <symbol id="icon-layersneeded" viewBox="0 0 37 32">
            <title>layersneeded</title>
            <path fill="#148686" d="M36.752 20.376l-4.413-4.57c2.185-2.959 1.737-7.099-1.030-9.523s-6.93-2.323-9.576 0.232c-2.646 2.555-2.892 6.712-0.567 9.562s6.448 3.442 9.481 1.361l4.413 4.57 1.691-1.633zM20.794 11.525c0.057-3.245 2.733-5.83 5.978-5.773s5.83 2.733 5.773 5.978c-0.057 3.245-2.733 5.83-5.978 5.773-3.244-0.060-5.826-2.735-5.773-5.978z"></path>
            <path fill="#40c5cc" d="M2.641 6.247l18.225-4.883c0.325-0.087 0.659 0.106 0.747 0.431l6.209 23.171c0.087 0.325-0.106 0.659-0.431 0.747l-18.225 4.883c-0.325 0.087-0.659-0.106-0.746-0.431l-6.209-23.171c-0.087-0.325 0.106-0.659 0.431-0.747z"></path>
            <path fill="#fff" d="M16.175 10.629c0.64 2.389-0.8 4.85-3.216 5.497s-4.894-0.764-5.534-3.153c-0.64-2.389 0.8-4.85 3.216-5.497s4.894 0.764 5.534 3.153z"></path>
            <path fill="#2ca4a4" d="M11.8 11.801l1.288 4.806c-1.913 0.512-3.86-0.136-5.079-1.511l3.791-3.295z"></path>
            <path fill="#fff" d="M9.862 21.712l12.935-3.466 0.262 0.978-12.935 3.466-0.262-0.978z"></path>
            <path fill="#fff" d="M10.517 24.158l12.935-3.466 0.262 0.978-12.935 3.466-0.262-0.978z"></path>
          </symbol>
          <symbol id="icon-pin" viewBox="0 0 26 32">
            <title>pin</title>
            <path d="M12.648 32c-0.305 0-0.61-0.152-0.914-0.305-0.457-0.457-11.733-9.448-11.733-19.048 0-7.162 5.486-12.648 12.648-12.648s12.648 5.486 12.648 12.648c0 9.6-11.276 18.59-11.733 19.048-0.305 0.152-0.61 0.305-0.914 0.305zM12.648 3.048c-5.333 0-9.6 4.267-9.6 9.6 0 6.552 7.010 13.562 9.6 15.848 2.59-2.286 9.6-9.143 9.6-15.848 0-5.333-4.267-9.6-9.6-9.6zM12.648 18.59c-3.352 0-5.943-2.743-5.943-5.943s2.743-5.943 5.943-5.943 5.943 2.743 5.943 5.943-2.59 5.943-5.943 5.943zM12.648 9.752c-1.676 0-2.895 1.371-2.895 2.895s1.371 2.895 2.895 2.895c1.676 0 2.895-1.371 2.895-2.895s-1.219-2.895-2.895-2.895z"></path>
          </symbol>
          <symbol id="icon-poligono" viewBox="0 0 39 32">
          ...
          <symbol id="icon-analysis" viewBox="0 0 36 32">
            ...
            <path fill="#2f939c" d="M0 27h36v5h-36v-5z"></path>
            <path fill="#2f939c" d="M6 24h3c0.828 0 1.5-0.672 1.5-1.5v-13.5c0-0.828-0.672-1.5-1.5-1.5h-3c-0.828 0-1.5 0.672-1.5 1.5v13.5c0 0.828 0.672 1.5 1.5 1.5z"></path>
            <path fill="#2f939c" d="M16.5 24h3c0.828 0 1.5-0.672 1.5-1.5v-21c0-0.828-0.672-1.5-1.5-1.5h-3c-0.828 0-1.5 0.672-1.5 1.5v21c0 0.828 0.672 1.5 1.5 1.5z"></path>
            <path fill="#2f939c" d="M25.5 15v7.5c0 0.828 0.672 1.5 1.5 1.5h3c0.828 0 1.5-0.672 1.5-1.5v-7.5c0-0.828-0.672-1.5-1.5-1.5h-3c-0.828 0-1.5 0.672-1.5 1.5z"></path>
          </symbol>

      ...
      <svg ariaHidden="true" style={{ position: 'absolute', width: 0, height: 0, overflow: 'hidden' }} version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
        <defs>
          ...
          <symbol id="icon-layersneeded" viewBox="0 0 37 32">
            ...
            <path d="M2.641 6.247l18.225-4.883c0.325-0.087 0.659 0.106 0.747 0.431l6.209 23.171c0.087 0.325-0.106 0.659-0.431 0.747l-18.225 4.883c-0.325 0.087-0.659-0.106-0.746-0.431l-6.209-23.171c-0.087-0.325 0.106-0.659 0.431-0.747z"></path>

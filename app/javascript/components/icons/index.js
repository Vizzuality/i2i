      ...
      <svg ariaHidden="true" style={{ position: 'absolute', width: 0, height: 0, overflow: 'hidden' }} version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
        <defs>
          ...
          <symbol id="icon-layersneeded" viewBox="0 0 37 32">
            ...
            <path d="M36.752 20.376l-4.413-4.57c2.185-2.959 1.737-7.099-1.030-9.523s-6.93-2.323-9.576 0.232c-2.646 2.555-2.892 6.712-0.567 9.562s6.448 3.442 9.481 1.361l4.413 4.57 1.691-1.633zM20.794 11.525c0.057-3.245 2.733-5.83 5.978-5.773s5.83 2.733 5.773 5.978c-0.057 3.245-2.733 5.83-5.978 5.773-3.244-0.060-5.826-2.735-5.773-5.978z"></path>
            <path fd="M2.641 6.247l18.225-4.883c0.325-0.087 0.659 0.106 0.747 0.431l6.209 23.171c0.087 0.325-0.106 0.659-0.431 0.747l-18.225 4.883c-0.325 0.087-0.659-0.106-0.746-0.431l-6.209-23.171c-0.087-0.325 0.106-0.659 0.431-0.747z"></path>
            <path d="M16.175 10.629c0.64 2.389-0.8 4.85-3.216 5.497s-4.894-0.764-5.534-3.153c-0.64-2.389 0.8-4.85 3.216-5.497s4.894 0.764 5.534 3.153z"></path>
            <path d="M11.8 11.801l1.288 4.806c-1.913 0.512-3.86-0.136-5.079-1.511l3.791-3.295z"></path>
            <path d="M9.862 21.712l12.935-3.466 0.262 0.978-12.935 3.466-0.262-0.978z"></path>
            <path d="M10.517 24.158l12.935-3.466 0.262 0.978-12.935 3.466-0.262-0.978z"></path>
          </symbol>

(function (App) {
  ...
  var MOBILE_SURVEYS_INDICATORS = [
    ...
    { id: 'i2i_Education', name: 'Level of education', category: categories.EXPLORATORY_SURVEY, defaultChart: 'grouped bar', visible: true, isFullWidth: true },
    
    
    { id: 'main_lan', name: 'Main language', category: categories.EXPLORATORY_SURVEY, defaultChart: 'grouped bar', visible: true, isFullWidth: true },
    ...
    { id: 'children_decission', name: 'Children decision maker', category: categories.EXPLORATORY_SURVEY, defaultChart: 'grouped bar', visible: true, isFullWidth: true },
    ...
    { id: 'freq_inconme_spouse', name: 'Income frequency of spouse', category: categories.EXPLORATORY_SURVEY, defaultChart: 'grouped bar', visible: true, isFullWidth: true }, 
